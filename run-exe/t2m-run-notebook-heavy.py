...
def run_notebook(path):
    with open(path + "\\t2m-notebook-heavy.ipynb", "r", encoding="utf-8") as f:
...
def run_test():
    ...
    current_time, run_state = get_current_time(dt.time(8, 30), dt.time(11, 30), dt.time(13, 00), dt.time(15, 10), dt.time(19, 00), dt.time(20, 00))
...
print("Runing data heavy test...")
run_test()
time.sleep(60)

print("Runing data heavy data ...")
while True:
    try:
        start_time = time.time()
        current_time, run_state = get_current_time(dt.time(8, 30), dt.time(11, 30), dt.time(13, 00), dt.time(15, 10), dt.time(19, 00), dt.time(20, 00))
